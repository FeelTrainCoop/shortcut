...
class LoginFacebookComponent extends React.PureComponent {
  ...
  render() {
    if (this.props.fbName) {
      return (
        <div className="loginrow-component" onClick={this.props.fbLogout}>
          <ListItem onClick={this.connect} button>
            <ListItemIcon>
            ...
            <ListItemText primary={this.props.fbName} />
